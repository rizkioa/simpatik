...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='izin',
            name='pembaharuan',
            field=models.CharField(max_length=20, null=True, verbose_name=b'Pembaharuan', blank=True),
        ),
        migrations.AlterField(
            model_name='izin',
            name='pendaftaran',
            field=models.CharField(max_length=20, null=True, verbose_name=b'Pendaftaran', blank=True),
        ),
    ]
