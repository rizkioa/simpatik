...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='izin',
            name='create_by',
            field=models.ForeignKey(related_name='izin_create_by', verbose_name=b'Dibuat Oleh', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        # migrations.AlterField(
        #     model_name='izin',
        #     name='jenis_gangguan',
