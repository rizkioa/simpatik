			...
			if jenis_izin and tanggal_:
				...
				try:
					...
					if jenisizin_obj.kode == "503.08":
						...
						columns = ['Nomor Pengajuan', 'Nomor Izin', 'Nama Pemohon', 'Nomor Identitas Pemohon', 'NPWP Perusahaan', 'Nama Perusahaan', 'Alamat Perusahaan', 'Jenis Badan Usaha', 'Status Perusahaan', 'Status Penanaman Modal', 'Tanggal Pendirian', 'Tanggal mulai kegiatan', 'Kegiatan Usaha Pokok', 'Omset Per Tahun', 'Modal Dasar', 'Modal ditempatkan', 'Modal disetor Rp.', 'Jumlah Karyawan']
						...
						columns = ['Nomor Pengajuan', 'Nomor Izin', 'Nama Pemohon', 'Nomor Identitas Pemohon', 'NPWP Perusahaan', 'Nama Perusahaan', 'Alamat Perusahaan', 'Jenis Badan Usaha', 'Status Perusahaan', 'Status Penanaman Modal', 'Tanggal Pendirian', 'Tanggal mulai kegiatan', 'Kegiatan Usaha Pokok', 'Omset Per Tahun', 'Modal Dasar', 'Modal ditempatkan', 'Modal disetor Rp.', 'Total Aset', 'Jumlah Karyawan']
						for i in pengajuan_list:
							tanggal_pendirian = ""
							tanggal_mulai_kegiatan = ""
							jenis_perusahaan = ""
							...
							isi_pengajuan = (i.no_pengajuan, i.no_izin, i.pemohon.nama_lengkap, i.pemohon.username, i.perusahaan.npwp, i.perusahaan.nama_perusahaan, i.perusahaan.alamat_perusahaan, jenis_perusahaan, status_perusahaan, jenis_penanaman_modal, tanggal_pendirian, tanggal_mulai_kegiatan, i.produk_utama, i.omset_per_tahun, i.modal_dasar, i.modal_ditempatkan, i.modal_disetor, i.total_aset, i.jumlah_karyawan_wni)
							rows.append(isi_pengajuan)
						...
						columns = ['Nomor Pengajuan', 'Nomor Izin', 'Nama Pemohon', 'Nomor Identitas Pemohon', 'NPWP Perusahaan', 'Nama Perusahaan', 'Alamat Perusahaan', 'Jenis Badan Usaha', 'Status Perusahaan', 'Status Penanaman Modal', 'Tanggal Pendirian', 'Tanggal mulai kegiatan', 'Kegiatan Usaha Pokok', 'Omset Per Tahun', 'Simpanan Pokok', 'Simpanan Wajib', 'Dana Cadangan', 'Hibah', 'Total Aset', 'Jumlah Karyawan']
						for i in pengajuan_list:
							tanggal_pendirian = ""
							tanggal_mulai_kegiatan = ""
							jenis_perusahaan = ""
							...
							isi_pengajuan = (i.no_pengajuan, i.no_izin, i.pemohon.nama_lengkap, i.pemohon.username, i.perusahaan.npwp, i.perusahaan.nama_perusahaan, i.perusahaan.alamat_perusahaan, jenis_perusahaan, status_perusahaan, jenis_penanaman_modal, tanggal_pendirian, tanggal_mulai_kegiatan, i.produk_utama, i.omset_per_tahun, i.modal_sendiri_simpanan_pokok, i.modal_sendiri_simpanan_wajib, i.modal_sendiri_dana_cadangan, i.modal_sendiri_hibah, i.total_aset, i.jumlah_karyawan_wni)
							rows.append(isi_pengajuan)
						...
						rows = pengajuan_list.values_list('no_pengajuan', 'no_izin', 'pemohon__nama_lengkap', 'pemohon__username', 'perusahaan__npwp', 'perusahaan__nama_perusahaan', 'perusahaan__alamat_perusahaan', 'bangunan', 'luas_bangunan', 'lokasi', 'luas_tanah', 'status_hak_tanah', 'tanggal_surat_tanah', 'klasifikasi_jalan', 'ruang_milik_jalan', 'ruang_pengawasan_jalan')
