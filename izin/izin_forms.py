...
class InformasiKekayaanDaerahForm(forms.ModelForm):
	class Meta:
		...
		fields = ('lokasi','desa','luas','no_rekomendasi','jenis_penggunaan','penggunaan')
