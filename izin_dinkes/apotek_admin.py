...
class ApotekAdmin(admin.ModelAdmin):
	...
	def cetak_skizin(self, request):
		...
		# 	})
		return render(request, "front-end/include/formulir_izin_apotik/cetak_skizin_apotek.html")
	...
	def get_urls(self):
		...
		my_urls = patterns('',
			...
			url(r'^cetak/$', self.admin_site.admin_view(self.cetak_skizin), name='apotek__cetak_skizin'),
