...
;(function (root, factory) {
    ...
    if(!$){
        throw new TypeError("å¿…é¡»å¼•å…¥jqueryåº“æ–¹å¯æ­£å¸¸ä½¿ç”¨ï¼");
    }
    ...
    MLoading.defaultOptions = {
        ...
        html:false,
        content:"",//è®¾ç½®contentåŽï¼Œtextå’Œiconè®¾ç½®å°†æ— æ•ˆ
        mask:true//æ˜¯å¦æ˜¾ç¤ºé®ç½©ï¼ˆåŠé€æ˜ŽèƒŒæ™¯ï¼‰
    };
