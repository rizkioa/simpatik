...
$('.stap5_pengesahan_menteri_koperasi').prop('disabled', true).trigger("chosen:updated");
$('#form-akta_pengesahaan_menteri_koperasi').hide()
$("#switch_stap5_pengesahan_menteri_koperasi_disabled").change(function() {
  if ($(this).is(':checked')) {
    $('.stap5_pengesahan_menteri_koperasi').prop('disabled', false).trigger("chosen:updated");
    $('#form-akta_pengesahaan_menteri_koperasi').show()
...
$('.stap5_persetujuan_menteri_koperasi').prop('disabled', true).trigger("chosen:updated");
$('#form-akta_persetujuan_menteri_koperasi').hide()
$("#switch_stap5_persetujuan_menteri_koperasi_disabled").change(function() {
  if ($(this).is(':checked')) {
    $('.stap5_persetujuan_menteri_koperasi').prop('disabled', false).trigger("chosen:updated");
