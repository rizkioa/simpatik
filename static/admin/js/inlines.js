...
function choosen_update(elemen_){
  elemen_.next().remove()
  elemen_.show()
  elemen_.addClass('form-control')
  // alert(elemen_)
  //elemen_.choosen()
}
(function($) {
  //django.jQuery('#id_nomoridentitaspengguna_set-0-jenis_identitas').choosen()
    ...
    $.fn.formset = function(opts) {
      ...
      if ($this.length && showAddButton) {
        ...
        addButton.click(function(e) {
          ...
          sel = row.find('.chosen-select')
          if(sel.length > 0){
            choosen_update(django.jQuery("#"+sel.attr('id')))
          }
        });
      }
      return this;
